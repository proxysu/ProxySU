...
namespace ProxySuper.Core.Models.Projects
{
    public partial class XraySettings
    {
        ...
        public string VLESS_TCP_ShareLink
        {
            get
            {
                return ShareLink.XrayBuild(RayType.VLESS_TCP, this);
            }
        }
        ...
        public string VLESS_WS_ShareLink
        {
            get
            {
                return ShareLink.XrayBuild(RayType.VLESS_WS, this);
            }
        }
        ...
        public string VLESS_KCP_ShareLink
        {
            get
            {
                return ShareLink.XrayBuild(RayType.VLESS_KCP, this);
            }
        }
        ...
        public string VLESS_QUIC_ShareLink
        {
            get
            {
                return ShareLink.XrayBuild(RayType.VLESS_QUIC, this);
            }
        }
        ...
        public string VLESS_gRPC_ShareLink
        {
            get
            {
                return ShareLink.XrayBuild(RayType.VLESS_gRPC, this);
            }
        }
    }
}
